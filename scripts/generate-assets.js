...
function createSplash(width, height, filename) {
  ...
  ctx.quadraticCurveTo(centerX + logoSize/2, centerY - logoSize/2, centerX + logoSize/2, centerY - logoSize/2 + logoRadius);
  ctx.lineTo(centerX + logoSize/2, centerY + logoSize/2 - logoRadius);
  ctx.quadraticCurveTo(centerX + logoSize/2, centerY + logoSize/2, centerX + logoSize/2 - logoRadius, centerY + logoSize/2);
  ctx.lineTo(centerX - logoSize/2 + logoRadius, centerY + logoSize/2);
  ctx.quadraticCurveTo(centerX - logoSize/2, centerY + logoSize/2, centerX - logoSize/2, centerY + logoSize/2 - logoRadius);
  ctx.lineTo(centerX - logoSize/2, centerY - logoSize/2 + logoRadius);
  ctx.quadraticCurveTo(centerX - logoSize/2, centerY - logoSize/2, centerX - logoSize/2 + logoRadius, centerY - logoSize/2);
